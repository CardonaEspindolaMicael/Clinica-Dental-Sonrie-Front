...
const NuevoTratamiento = () => {
    ...
    const tratamientoToUpdate = miEstado.objeto;
    console.log(tratamientoToUpdate.id)
    const fetchUsers = async (values) => {
        try {
            await ApiRequests.putCommon(`api/Tratamientos/Update/${miEstado.identificador}`, values);
    ...
    const formik = useFormik({
        initialValues: {
            descripcion: tratamientoToUpdate.descripcion,
            precio: tratamientoToUpdate.precio,
            idServicio: tratamientoToUpdate.idServicio,
            estado: true
        },
        onSubmit: values => {
            fetchUsers(values);
