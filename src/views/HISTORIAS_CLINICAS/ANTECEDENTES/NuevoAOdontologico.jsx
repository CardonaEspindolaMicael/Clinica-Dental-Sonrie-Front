...
const NuevoAntecedenteOdontologico = () => {
    ...
    const fetchAnt = async (values) => {
        try {
            await ApiRequests.postCommon('api/HistorialesClinicas/AntecedenteOdontologico/Create', values);
    ...
    const formik = useFormik({
        initialValues: {
            ...
            frecuenciaCepillado: "",
            tipoCepilloDental: "",
            usaEnjuagueBucal: false,
            usaHiloDental: false,
            usaPastaDental: false,
        },
        onSubmit: values => {
            fetchAnt(values);
        },
...
export default NuevoAntecedenteOdontologico;
