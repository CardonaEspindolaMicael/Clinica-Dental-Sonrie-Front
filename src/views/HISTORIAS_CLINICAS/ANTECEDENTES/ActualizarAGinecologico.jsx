...
const ActualizarAntecedenteGinecologico = () => {
    ...
    const fetchAnt = async (values) => {
        try {
            await ApiRequests.putCommon(`api/HistorialesClinicas/AntecedenteGinecologico/Update/${miEstado.identificador}`, values);
    ...
    const formik = useFormik({
        initialValues: {
            ...
            ultimoPeriodoMenstrual: toUpdate.ultimoPeriodoMenstrual,
            problemasMenstruacion: toUpdate.problemasMenstruacion,
            semanasEmbarazo: toUpdate.semanasEmbarazo
        },
        onSubmit: values => {
            fetchAnt(values);
        },
...
export default ActualizarAntecedenteGinecologico;
