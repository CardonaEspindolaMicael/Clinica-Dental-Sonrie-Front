...
const ActualizarDoctor = () => {
 ...
 const fetchUsers = async (values) => {
  try {
    await usuarioApis.putCommon(`api/Doctores/Update/${miEstado.identificador}`, values);
  ...
  const formik = useFormik({
    initialValues: {
      ...
      especialidad:usuarioToUpdate.especialidad,
      idSucursal:usuarioToUpdate.idSucursal
    },
    onSubmit: values => {
      fetchUsers(values);
    },
