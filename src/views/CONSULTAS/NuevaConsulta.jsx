...
const NuevaConsulta = () => {
  ...
  const fetchUsers = async (values) => {
    try {
      await ApiRequests.postCommon('api/Consultas/Create', values);
  ...
  return (
    <form style={{ margin: '20px 50px 0 50px' }} className="row  mt-6 g-2  needs-validation" novalidate onSubmitCapture={formik.handleSubmit}>
      ...
      <legend>Formulario de Registro de Consultas</legend>
      <hr class="border border-primary border-2 opacity-50"></hr> <div className="input-group input-group-lg">
